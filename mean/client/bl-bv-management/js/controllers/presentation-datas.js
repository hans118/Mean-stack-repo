...
angular.module('blApp.management.controllers').controller(
    'PresentationDataSensorController',
        ['$scope', '$rootScope', '$compile', '$http', '$timeout', '$q', '$filter', 'TagService', 'notifyService',
        function ($scope, $rootScope, $compile, $http, $timeout, $q, $filter, TagService, notifyService) {
            ...
            * @return {object}
            */
            $scope.buildUserDataSourceTree = function() {
            ...
            */
            $scope.init = function () {
                $scope.buildUserDataSourceTree().then(function(result){
                });
            };
