...
.config(
    ['$stateProvider', '$urlRouterProvider', '$locationProvider', 'uiSelectConfig', '$analyticsProvider',
     'configurationProvider',
    function($stateProvider, $urlRouterProvider, $locationProvider, uiSelectConfig, $analyticsProvider,
             configurationProvider) {
    ...
    if (!configurationProvider.config('siteAnalytics')) {
